                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('applicable_categories') is-invalid @enderror" 
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" {{ in_array($category->id, old('applicable_categories', $coupon->applicable_categories ?? [])) ? 'selected' : '' }}>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12">
                            ...
                            <select class="form-select @error('excluded_products') is-invalid @enderror" 
                                ...
                                @foreach($products as $product)
                                    <option value="{{ $product->id }}" {{ in_array($product->id, old('excluded_products', $coupon->excluded_products ?? [])) ? 'selected' : '' }}>
                                        {{ $product->name }}
                                    </option>
                                @endforeach
                            </select>
