        ...
        <div class="col-md-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" type="checkbox" id="is_sku_optional" name="is_sku_optional" value="1" {{ old('is_sku_optional') ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        <label for="category_id" class="form-label small text-muted">Categories <span class="text-danger">*</span></label>
                        <div class="border rounded p-2" style="max-height: 200px; overflow-y: auto; background-color: #fff;">
                            @php
                                function renderCategoryCheckboxes($categories, $selected = [], $margin = 0) {
                                    foreach ($categories as $category) {
                                        ...
                                        if ($category->children->isNotEmpty()) {
                                            renderCategoryCheckboxes($category->children, $selected, $margin + 3);
                                        }
                                    }
                                }
                                $selectedCats = old('category_id', []);
                                renderCategoryCheckboxes($categories->whereNull('parent_id'), $selectedCats);
                            @endphp
                        </div>
                        @error('category_id')
                            <div class="invalid-feedback">{{ $message }}</div>
