    ...
    <div class="col-lg-4">
        <div class="card shadow-xs">
            <div class="card-header">
                <h6 class="mb-0 fw-semibold text-dark"><i class="bi bi-plus-circle me-2 text-primary"></i>Add Cancellation Reason</h6>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-8">
        <div class="card shadow-xs">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h6 class="mb-0 fw-semibold text-dark"><i class="bi bi-x-octagon me-2 text-primary"></i>Manage Reasons</h6>
                    ...
                    <table class="table table-hover mb-0 align-middle">
                        ...
                        <tbody>
                            @forelse($reasons as $index => $reason)
                                <tr>
                                    <td>
                                        <div class="fw-semibold text-dark">{{ $reason }}</div>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.settings.cancellation-reasons.update', $index) }}" method="POST" class="row g-1">
                                            ...
                                            <div class="col-4">
                                                <button type="submit" class="btn btn-xs btn-outline-primary w-100" {{ strtolower($reason) === 'other' ? 'disabled' : '' }}>
                                    ...
                                    <td class="text-end">
                                        @if(strtolower($reason) === 'other')
                                            <button type="button" class="btn btn-xs btn-outline-secondary" disabled title="System reason cannot be deleted">
