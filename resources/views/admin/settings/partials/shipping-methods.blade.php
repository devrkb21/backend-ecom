<div class="card shadow-xs">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h6 class="mb-0 fw-semibold text-dark"><i class="bi bi-truck me-2 text-primary"></i>Shipping Methods</h6>
                ...
                <tbody id="sortable-methods">
                    @forelse($methods as $method)
                        <tr data-id="{{ $method->id }}">
                            ...
                            <td>
                                <div class="fw-semibold text-dark">{{ $method->name }}</div>
                            ...
                            <td class="text-center">
                                <form action="{{ route('admin.settings.shipping-methods.toggle', $method) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('PATCH')
                                    <button type="submit" class="btn btn-xs {{ $method->is_active ? 'btn-success' : 'btn-outline-secondary' }}">
                            ...
                            <td>
                                <a href="{{ route('admin.settings.shipping-methods.edit', $method) }}" class="btn btn-xs btn-outline-primary me-1">
...
<div class="row mt-4 g-3">
    <div class="col-md-6">
        <div class="card shadow-xs">
            <div class="card-header">
                <h6 class="mb-0 fw-semibold text-dark"><i class="bi bi-info-circle me-2 text-primary"></i>About Shipping Methods</h6>
            </div>
            <div class="card-body">
    ...
    <div class="col-md-6">
        <div class="card shadow-xs">
            <div class="card-header">
                <h6 class="mb-0 fw-semibold text-dark"><i class="bi bi-lightbulb me-2 text-warning"></i>Tips</h6>
            </div>
            <div class="card-body">
                <ul class="text-muted small mb-0 ps-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const sortableMethodsEl = document.getElementById('sortable-methods');
        if (sortableMethodsEl) {
            new Sortable(sortableMethodsEl, {
                handle: '.drag-handle',
                animation: 150,
                onEnd: function() {
