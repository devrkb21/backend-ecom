    ...
    <div class="col-lg-4">
        <div class="card shadow-xs">
            <div class="card-header">
                <h6 class="mb-0 fw-semibold text-dark"><i class="bi bi-plus-circle me-2 text-primary"></i>Add Order Status</h6>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-8">
        <div class="card shadow-xs">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h6 class="mb-0 fw-semibold text-dark"><i class="bi bi-tags me-2 text-primary"></i>Manage Statuses</h6>
                    ...
                    <table class="table table-hover mb-0 align-middle">
                        ...
                        <tbody>
                            @forelse($statuses as $status)
                                <tr>
                                    <td>
                                        <div class="fw-semibold text-dark">{{ $status->key }}</div>
                                        @if($status->is_system)
                                    ...
                                    <td>
                                        <form action="{{ route('admin.settings.order-statuses.update', $status) }}" method="POST" class="row g-1">
                                            ...
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-xs btn-outline-primary w-100">
                                    ...
                                    <td class="text-end">
                                        @if($status->is_system || $status->orders_count > 0)
                                            <button type="button" class="btn btn-xs btn-outline-secondary" disabled title="In use/system status cannot be deleted">
