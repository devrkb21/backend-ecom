...
@section('title', 'Order SMS Templates')
@section('page-title', 'Order SMS Templates')
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0 fw-semibold"><i class="bi bi-info-circle me-2"></i>Placeholders</h6>
            </div>
            <div class="card-body">
                ...
                @if(!$smsEnabled)
                    <div class="alert alert-warning mt-3 mb-0 small">
                        ...
                        <a href="{{ route('admin.settings.integrations') }}">Enable it here</a> to send notifications.
                    </div>
                @else
        ...
        <form action="{{ route('admin.settings.sms-templates.update') }}" method="POST">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="mb-0 fw-semibold"><i class="bi bi-chat-dots me-2"></i>SMS Templates per Order Status</h6>
                ...
                <div class="card-body p-0">
                    ...
                    @empty
                        <div class="p-4 text-center text-muted">
                            ...
                            No order statuses found. <a href="{{ route('admin.settings.order-statuses') }}">Create some first</a>.
                        </div>
                    @endforelse
                </div>
