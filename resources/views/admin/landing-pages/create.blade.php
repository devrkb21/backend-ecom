    ...
    <div class="col-md-10">
        <div class="card shadow-sm border">
            <div class="card-header d-flex justify-content-between align-items-center bg-transparent border-bottom">
                <h6 class="mb-0 fw-semibold">Landing Page Specifications</h6>
                ...
                <form action="{{ route('admin.landing-pages.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="title" id="titleInput" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="e.g. Premium Mango Delights" required>
                            @error('title')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-medium">Frontend Custom URL (Slug)</label>
                            <input type="text" name="slug" id="slugInput" class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug') }}" placeholder="Leave empty to auto-generate (e.g. premium-mango)">
                            <div class="form-text">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="template_type" class="form-select @error('template_type') is-invalid @enderror" required>
                                <option value="default" {{ old('template_type', 'default') == 'default' ? 'selected' : '' }}>Default E-commerce</option>
                                <option value="clothing" {{ old('template_type') == 'clothing' ? 'selected' : '' }}>Clothing / Fashion</option>
                                <option value="am" {{ old('template_type') == 'am' ? 'selected' : '' }}>Mangoes (Am)</option>
                                <option value="khejur" {{ old('template_type') == 'khejur' ? 'selected' : '' }}>Dates (Khejur)</option>
                                <option value="digital_item" {{ old('template_type') == 'digital_item' ? 'selected' : '' }}>Digital Goods</option>
                                <option value="inner_item" {{ old('template_type') == 'inner_item' ? 'selected' : '' }}>Lingerie / Innerwear</option>
                                <option value="sexual_item" {{ old('template_type') == 'sexual_item' ? 'selected' : '' }}>Sensitive Health (Sexual)</option>
                            </select>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                <input type="color" class="form-control form-control-color border-end-0" id="themeColorPicker" value="{{ old('theme_color', '#E83434') }}" title="Choose accent color" style="max-width: 60px;">
                                <input type="text" name="theme_color" id="themeColorText" class="form-control @error('theme_color') is-invalid @enderror" value="{{ old('theme_color', '#E83434') }}" placeholder="#E83434" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-text">Supported formats: JPG, PNG, WEBP, SVG. Max: 4MB.</div>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="video_embed_code" class="form-control @error('video_embed_code') is-invalid @enderror" rows="2" placeholder='e.g. <iframe width="560" height="315" src="https://www.youtube.com/embed/..."></iframe\>'>{{ old('video_embed_code') }}</textarea>
                        ...
                        <div class="col-12 mt-4">
                            ...
                            <p class="text-muted small">Specify 3-5 highlights to show on the page (e.g. Free Delivery, Premium Quality, Fresh Organic fruits).</p>
                        ...
                        <div class="col-12 mt-4">
                            ...
                            <p class="text-muted small">Show positive social proof reviews with custom ratings to boost conversions.</p>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="custom_css" class="form-control @error('custom_css') is-invalid @enderror font-monospace" rows="4" placeholder="/* Custom styling overrides */">{{ old('custom_css') }}</textarea>
                        ...
                        <div class="col-12 mt-2">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="showLocation" name="show_location" value="1" {{ old('show_location', true) ? 'checked' : '' }}>
                        ...
                        <div class="col-12 mt-4 text-end">
                            <button type="submit" class="btn btn-success px-4 py-2">
                                <i class="bi bi-save me-1"></i> Create Landing Page
                            </button>
                        </div>
                    </div>
                </form>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Add 3 default features for ease of use
