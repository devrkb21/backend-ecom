                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <script>
                                ...
                                @php
                                    $currentIds = old('product_ids', $landingPage->product_ids ?? ($landingPage->product_id ? [$landingPage->product_id] : []));
                                @endphp
                                window.__lpSelectedIds = @json($currentIds);
                            </script>
                        </div>
...
<script>
    ...
    (function initProductMultiSelect() {
        ...
        function showDropdown() { renderDropdown(searchInput.value); dropdown.classList.remove('d-none'); }
        ...
        document.querySelector('.product-multiselect-wrapper').addEventListener('click', function() { searchInput.focus(); });
