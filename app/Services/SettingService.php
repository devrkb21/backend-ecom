    ...
    public function getDefaultSettings(): array
    {
        return [
            ...
            'general' => [
                ...
                ['key' => 'call_for_order_phone', 'type' => 'text', 'label' => 'Call For Order Phone', 'value' => ''],
                ['key' => 'whatsapp_order_phone', 'type' => 'text', 'label' => 'WhatsApp Order Number', 'value' => ''],
                ['key' => 'whatsapp_order_message', 'type' => 'textarea', 'label' => 'WhatsApp Order Message', 'value' => 'Assalamu Alaikum, I want to order: {product_name}. Product URL: {product_url}. Quantity: {quantity}.'],
                ['key' => 'open_side_cart_on_add', 'type' => 'boolean', 'label' => 'Open Side Cart After Add To Cart', 'value' => '1'],
